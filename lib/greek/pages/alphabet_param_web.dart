...
/// entry — refresh and share keep the selection, but flipping between the three
/// alphabets doesn't stuff the back button. The same approach as the Latin
/// page's own `?alphabet=` and the tally page's `?system=`.
