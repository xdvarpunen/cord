...
/// Small shared pieces of the `hangul-word` page furniture, kept to the ones
/// this single page uses — the tab shell, the word list and its target banner
/// did not come across.
...
/// tall enough for the syllables and their romanization together, and it
